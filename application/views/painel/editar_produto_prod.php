		...
		<div class="row">
			...
			<div class="col-xl-10 col-lg-9 col-md-12">
				...
				<div class="blocoSeguraCadastro">
					...
					<form action="<?= base_url('painel/updateProduto'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="col-12">
							<div class="form-group">
								<label>Nome</label>
								<input type="" name="nome" class="form-control" placeholder="Nome do produto" value="<?= $produto['nome'] ?>">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6 col-12">
								<div class="form-group">
									<label>Valor</label>
									<input type="" name="valor" class="form-control" placeholder="00.00" value="<?= $produto['valor'] ?>">
								</div>
							</div>
							...
							<div class="col-sm-6 col-12">
								<div class="form-group">
									<label>Estoque</label>
									<input type="" name="estoque" class="form-control" placeholder="Quantidade de itens" value="<?= $produto['estoque'] ?>">
								</div>
							</div>
						</div>
							...
							<div class="col-sm-6 col-12">
								<div class="form-group">
									...
									<select type="" name="frete_grande_porte" class="form-control">
										<option value="0" <?php if($produto['frete_grande_porte'] == 0){ echo 'selected'; } ?>>Não</option>
										<option value="1" <?php if($produto['frete_grande_porte'] == 1){ echo 'selected'; } ?>>Sim</option>
									</select>
								</div>
							</div>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<textarea name="descricao" class="form-control" placeholder="Descrição do produto" > <?= $produto['descricao'] ?> </textarea>
							</div> 
						</div>

						<div class="col-12 mgT10">
							<div class="form-group">
								<label>Escolher outra imagem</label>
								<input type="file" name="arquivo" style="">
							</div>
						</div>

						<div class="col-12 txC">
							<button type="submit" class="botao_cadastro">Editar</button>
						</div>
